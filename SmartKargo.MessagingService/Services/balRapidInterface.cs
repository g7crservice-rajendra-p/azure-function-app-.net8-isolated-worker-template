...
{    class balRapidInterface
    {
        ...
        public DataSet InsertRapidCTMTransaction(DateTime UpdatedOn, string strUserName, DateTime dtFromDate, DateTime dtToDate)
        {
        ...
        public DataSet InsertRapidCCAPXTransaction(DateTime UpdatedOn, string strUserName, DateTime dtFromDate, DateTime dtToDate)
        {
        ...
        public DataSet GetRapidCCAPXTransaction(string strFileName)
        {
            DataSet ds = new DataSet();
            try
            {
